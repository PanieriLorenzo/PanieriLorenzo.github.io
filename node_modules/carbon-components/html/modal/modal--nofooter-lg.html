...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ty6aj76sk0q">Show
  modal</button>

<div data-modal id="modal-ty6aj76sk0q" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ty6aj76sk0q-label" aria-describedby="modal-ty6aj76sk0q-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ty6aj76sk0q-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ty6aj76sk0q-heading">Modal heading</p>
