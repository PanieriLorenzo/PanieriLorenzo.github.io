...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ja2b4tth2ah">Show
  modal</button>

<div data-modal id="modal-ja2b4tth2ah" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ja2b4tth2ah-label" aria-describedby="modal-ja2b4tth2ah-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ja2b4tth2ah-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ja2b4tth2ah-heading">Modal heading</p>
