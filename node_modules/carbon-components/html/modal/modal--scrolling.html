...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-69rpnfsrzjw">Show
  modal</button>

<div data-modal id="modal-69rpnfsrzjw" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-69rpnfsrzjw-label" aria-describedby="modal-69rpnfsrzjw-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-69rpnfsrzjw-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-69rpnfsrzjw-heading">Modal heading</p>
