...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-i3hoi5d9lz">Show
  modal</button>

<div data-modal id="modal-i3hoi5d9lz" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-i3hoi5d9lz-label" aria-describedby="modal-i3hoi5d9lz-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-i3hoi5d9lz-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-i3hoi5d9lz-heading">Modal heading</p>
