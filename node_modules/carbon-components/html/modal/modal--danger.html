...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-jfhc3vnw86">Show
  modal</button>

<div data-modal id="modal-jfhc3vnw86" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-jfhc3vnw86-label" aria-describedby="modal-jfhc3vnw86-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jfhc3vnw86-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jfhc3vnw86-heading">Modal heading</p>
