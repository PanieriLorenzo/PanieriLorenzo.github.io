...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-kmabkro0gk">Show
  modal</button>

<div data-modal id="modal-kmabkro0gk" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-kmabkro0gk-label" aria-describedby="modal-kmabkro0gk-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-kmabkro0gk-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-kmabkro0gk-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
