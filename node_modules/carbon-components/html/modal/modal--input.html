...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-je2eo9vv4hp">Show
  modal</button>

<div data-modal id="modal-je2eo9vv4hp" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-je2eo9vv4hp-label" aria-describedby="modal-je2eo9vv4hp-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-je2eo9vv4hp-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-je2eo9vv4hp-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-je2eo9vv4hp" class="bx--label">Text Input label</label>
        <input id="text-input-je2eo9vv4hp" type="text" class="bx--text-input" placeholder="Optional placeholder text"
