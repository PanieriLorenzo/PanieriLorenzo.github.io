...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-h59dd2bnv3f">Show
  modal</button>

<div data-modal id="modal-h59dd2bnv3f" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-h59dd2bnv3f-label" aria-describedby="modal-h59dd2bnv3f-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-h59dd2bnv3f-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-h59dd2bnv3f-heading">Modal heading</p>
