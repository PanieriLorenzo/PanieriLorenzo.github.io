...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-g45ej2nowpo">Show
  modal</button>

<div data-modal id="modal-g45ej2nowpo" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-g45ej2nowpo-label" aria-describedby="modal-g45ej2nowpo-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-g45ej2nowpo-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-g45ej2nowpo-heading">Modal heading</p>
